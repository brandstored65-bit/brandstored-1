  ...
  return (
    <div className="bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-10 min-h-[60vh]">
        ...
        <p className="text-gray-600 mb-8">Were here to help. Choose an option below or email us at <a href="mailto:support@Brandstored.com" className="text-orange-600 underline">support@Brandstored.com</a>.</p>
        ...
        <div className="grid gap-4">
          ...
          <a href="mailto:support@Brandstored.com" className="block bg-white border border-gray-200 rounded-xl p-5 hover:shadow-md transition">
